                ...
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6">
                    ...
                    <input
                      ...
                      id="limite_personas"
                      autocomplete="limite_personas"
                      class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-30 shadow-sm sm:text-sm border-gray-300 rounded-md"
                    />
                  </div>
